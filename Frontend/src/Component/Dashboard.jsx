...
function Dashboard() {
  ...
  useEffect(() => {
    // Fetch total income
    axios
      .get("http://localhost:5000/api/financialdata/total-income")
      .then((response) => {
    ...
    axios
      .get("http://localhost:5000/api/financialdata/total-expenses")
      .then((response) => {
    ...
    axios
      .get("http://localhost:5000/api/financialdata/total-investments")
      .then((response) => {
